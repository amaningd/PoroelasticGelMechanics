%% [tau, F] = poroelasticForceResponse() returns the force, F, exerted by a poroelastic gel on an indenter

function [tau, F] =  poroelasticForceResponse_normTime(h, shape, w, E0, nu, D, mode)
...
if strcmp(mode, 'plot')
    ...
    xlabel('Normalized time, \tau = Dt/a^2');
